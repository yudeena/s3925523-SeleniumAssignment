...
@XmlType(name = "RemoteTestCaseParameter", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v3_0.DataObjects", propOrder = {
    "defaultValue",
    "name",
    "testCaseId",
    "testCaseParameterId"
...
public class RemoteTestCaseParameter {
    ...
    @XmlElementRef(name = "DefaultValue", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v3_0.DataObjects", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "TestCaseParameterId", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v3_0.DataObjects", type = JAXBElement.class)
