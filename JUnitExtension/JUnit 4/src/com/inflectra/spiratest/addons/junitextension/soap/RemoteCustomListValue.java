...
@XmlType(name = "RemoteCustomListValue", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v3_0.DataObjects", propOrder = {
    "active",
...
public class RemoteCustomListValue {
    ...
    @XmlElementRef(name = "CustomPropertyValueId", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v3_0.DataObjects", type = JAXBElement.class)
